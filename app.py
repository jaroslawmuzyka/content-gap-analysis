...
# ================================
# KROK 6: Wgranie Danych Własnej Strony
# ================================
...
# ================================
# KROK 7: Weryfikacja Istniejących Treści
# ================================
  ...
  "uzasadnienie": "Krótkie uzasadnienie 1 zdanie"
        ...
        if st.button("Rozpocznij Weryfikację AI", type="primary"):
            if len(df_accepted) == 0:
                ...
                # Prepare my_pages_context string
                my_pages_context = ""
                ...
                # Ensure context is not insanely large, cut at 80k characters
